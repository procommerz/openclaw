export const CDP_HTTP_REQUEST_TIMEOUT_MS = 5000;
export const CDP_WS_HANDSHAKE_TIMEOUT_MS = 5000;
export const CDP_JSON_NEW_TIMEOUT_MS = 2500;

export const CHROME_REACHABILITY_TIMEOUT_MS = 1500;
export const CHROME_WS_READY_TIMEOUT_MS = 3000;
...
export const PROFILE_HTTP_REACHABILITY_TIMEOUT_MS = 500;
export const PROFILE_WS_REACHABILITY_MIN_TIMEOUT_MS = 500;
export const PROFILE_WS_REACHABILITY_MAX_TIMEOUT_MS = 2000;
export const PROFILE_ATTACH_RETRY_TIMEOUT_MS = 2000;
